...
const socialLogos = computed(() => [
  {
    name: "Linkedin",
    src: linkedinSrc,
    link: "https://linkedin.com/in/jorge-miranda-dev",
  },
...
<template>
  <section class="px-5 pt-8">
    <div class="w-full max-w-[600px] mx-auto">
      <div
        class="px-[15px] bg-dark text-gray py-[55px] lg:px-[60px] sm:rounded-t-[15px]"
      >
        <div>
          <div
          ...
          >
            <picture class="w-auto h-[50px] relative justify-start">
              <a href="/">
                <img
                  :src="LogoSrc"
                  alt="Logo for Litlynx Brand"
                  class="w-full h-full object-contain"
                />
              </a>
            </picture>
            <ul class="flex gap-5">
              <li v-for="logo in socialLogos" :key="logo.name">
                <a :href="logo.link" target="_blank">
                  <picture>
                    <img
                      :src="logo.src"
                      :alt="logo.name"
                      class="w-[35px] h-[35px] text-white"
                    />
                  </picture>
                </a>
              </li>
          ...
          <div class="flex flex-col lg:flex-row mt-[66px] mb-[51px]">
            ...
            >
              <h3 class="text-center md:text-left text-2xl text-cyan-400">
                Contact us
              </h3>
        ...
        <div
          class="text-sm flex flex-col lg:flex-row justify-center mt-4 text-center md:justify-between md:mt-0"
        >
          <span>
            {{ currentYear }} @ Litlynx - Made With
            <a class="underline" target="_blank" href="https://astro.build"
              >Astro</a
            >
            &
            <a class="underline" target="_blank" href="https://vuejs.org"
              >Vue</a
            > </span
          >&nbsp;
        </div>
